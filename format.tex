...
{enhanced,
  ...
  % A breakable box nested in a breakable box needs this, or the part is
  % pushed whole to the next page. The enclosing problem draws the
  % continuation note; a part drawing its own would print a second, colliding
  % note whenever a break lands inside a part.
  enforce breakable,
  colback = white,
  colbacktitle = white,
  coltitle = black,
